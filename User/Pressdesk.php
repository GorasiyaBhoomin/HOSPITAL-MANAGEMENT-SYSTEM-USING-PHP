            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-xl-3 col-lg-2">
                        <div class="logo">
                            <a href="index.html">
                                <img src="img/logo2.png" alt="" height="60px" width="250px">
                            </a>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text">
                        <h3>Press Desk</h3>
                        <p><a href="index.html">Home /</a> Press Desk</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-md-6 col-lg-4">
                <div class="single_department">
                    <div class="department_thumb">
                        <img src="img/press desk/blog1.jpg" alt="">
                    </div>
            ...
            <div class="col-xl-4 col-md-6 col-lg-4">
                <div class="single_department">
                    <div class="department_thumb">
                        <img src="img/press desk/blog2.jpg" alt="">
                    </div>
                    <div class="department_content">
                        <p>webfjbje</p>
                    </div>
                ...
                <div class="single_department">
                    <div class="department_thumb">
                        <img src="img/press desk/blog3.jpg" alt="">
                    </div>
                    <div class="department_content">
                        <p>qewnfbjqb</p>
                    </div>
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="footer_widget">
                        <div class="footer_logo">
                            <a href="#">
                                <img src="img/logo2.png" alt="" height="70px" width="250px">
                            </a>
                        </div>
                        <p>
