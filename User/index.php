            ...
            <div class="row">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        $avatarPath = !empty($row['avatar']) ? '../admin/' . $row['avatar'] : 'assets/img/user.jpg';
                        
                        echo '<div class="col-md-6 col-lg-4">
                                <div class="single_expert mb-40">
                                    <div class="expert_thumb">
                                        <img src="' . $avatarPath . '" alt="Doctor Image" onerror="this.src=\'assets/img/user.jpg\' " height="400px" width="250px">
                                    </div>
                                    <div class="experts_name text-center">
                                        <a href="index.php?id=' . $row['id'] . '"><h3>' . $row['username'] . '</h3></a>
                                        <span>' . $row['departmentname'] . '</span><br>
                                        <span>Doctor ID: ' . $row['id'] . '</span>
