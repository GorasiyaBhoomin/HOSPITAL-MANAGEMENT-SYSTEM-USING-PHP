                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="welcome_docmed_info">
                        ...
                        <h3>Best Care For Your <br>
                                Good Health</h3>
                        <p>Shree Kutchi Leva Patel Education and Medical trust works with the sole aim of betterment of society in terms of education and healthcare services. K.K.Patel super speciality hospital is one of the initiative to enhance the present healthcare services provided by the Trust under name of existing specility hospital namely MMPJ hospital.</p>
                        <ul>
                            <li> <i class="flaticon-right"></i>Spread over a large campus of 13 acres  </li>
                            <li> <i class="flaticon-right"></i>200+ bed hospital </li>
                            <li> <i class="flaticon-right"></i>  Easy Accessibility</li>
                            <li> <i class="flaticon-right"></i>     Modular Operation Theatres for High End Surgeries
                            </li>
                            <li> <i class="flaticon-right"></i>   High Tech Cath-lab for cardiology
                            </li>
                            <li> <i class="flaticon-right"></i>Patient-centered designed physical facility</li>
                            <li> <i class="flaticon-right"></i>   Radiation therapy Advanced Linear-accelerator
                            </li>
                            <li> <i class="flaticon-right"></i>     128 slice Cardiac CT scan With AI camera
                            </li>
                            <li> <i class="flaticon-right"></i>    Residential facility for Staff & patient’s relative
                            </li>
                ...
                <div class="col-xl-6">
                    <div class="single_emergency d-flex align-items-center justify-content-center emergency_bg_1 overlay_skyblue">
                        ...
                        <div class="info_button">
                            <a href="tel:+917359007000" class="boxed-btn3-white">+91 73590 07000</a>
                          </div>
                    </div>
                </div>
                <div class="col-xl-6">
