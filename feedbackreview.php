...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        ...
        try {
            ...
            //Recipients
            $mail->setFrom('gorasiyabhoomin@gmail.com', 'KKP Hospital');
            $mail->addAddress($email, $name); // To user

            //Content
            $mail->isHTML(true);
            $mail->Subject = 'Thank you giving feedback to KKP Hospital';
            $mail->Body    = "
                <h3>Hello $name</h3>
            ...
            $mail->send();
            $_SESSION['success'] = "Feedback submitted and email sent successfully!";
        } catch (Exception $e) {
            $_SESSION['success'] = "Feedback saved, but email failed to send.";
        }

        header("Location: feedbackreview.php");
        exit();
    } else {
        $_SESSION['error'] = "Error submitting feedback: " . $con->error;
    }
}
?>
<!doctype html>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text">
                        ...
                        <p><a href="index">Home /</a> Feedback & Review</p>
                    </div>
                </div>
            </div>
        </div>
              ...
              <div class="card card-registration my-4">
                <div class="row g-0">
                  <div class="col-xl-6 d-none d-xl-block">
                    <img src="assets2/img/banner/gallery10-removebg-preview.png" height="1000px" width="1200px"
                  ...
                  <div class="col-xl-6">
                    <div class="card-body p-md-5 text-black">
                        ...
                        <form action="feedbackreview.php" id="feedback-form" method="post">
                      <h3 class="mb-5 text-uppercase">Write Your Review</h3>
                        ...
                        <div class="form-outline mb-4">
                            <input type="text" name="email" id="email" placeholder="Email ID" class="form-control form-control-lg" />
                          ...
                          <div class="col-12">
                            <div class="form-group">
                                <textarea class="form-control w-100" name="message" id="message" cols="30" rows="9" placeholder="Review"></textarea>
