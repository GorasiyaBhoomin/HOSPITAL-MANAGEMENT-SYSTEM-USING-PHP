...
if(isset($_POST['create_expense'])){
    ...
    $sql = "INSERT INTO expenses (title, amount, category, expense_date, description) VALUES (?, ?, ?, ?, ?)";
    $stmt = $con->prepare($sql);
    $stmt->bind_param("sdsss", $title, $amount, $category, $date, $description);
                ...
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <form action="add_expense.php" method="POST">
                        ...
                        <div class="m-t-20 text-center">
                            <button type="submit" class="btn btn-primary submit-btn" name="create_expense">Add Expense</button>
                        </div>
                    </form>
                </div>
            </div>
