...
if(isset($_POST['create_department'])){
    ...
    $insert = "INSERT INTO departments (departmentname, departmenthead, description, departmentimage) 
               VALUES ('$departmentname', '$departmenthead', '$description', '$departmentimage')";
...
$(document).ready(function () {
        ...
        messages: {
            departmentimage: {
                required: "Please upload a department image",
...
<div class="main-wrapper">
    ...
    <div class="row">
        <div class="col-lg-8 offset-lg-2">
            ...
            <form action="add-department.php" id="add-department" method="POST" enctype="multipart/form-data">
                <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="departmentname" value="">
                   
                </div>
                <div class="form-group">
                    <label>Department Head</label>
                    <input class="form-control" type="text" name="departmenthead" value="Dr." value="">
                ...
                <div class="m-t-20 text-center">
                    <button class="btn btn-primary submit-btn" id="create_department" name="create_department">Create Department</button>
                </div>
            </form>
        </div>
    </div>
