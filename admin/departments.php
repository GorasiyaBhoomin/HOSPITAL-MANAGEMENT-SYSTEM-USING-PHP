...
if(isset($_GET['id'])) {
    $dept_id = $_GET['id'];
    $delete_dept = "DELETE FROM departments WHERE id = ?";
    $stmt = $con->prepare($delete_dept);
    $stmt->bind_param("i", $dept_id);
    
    if($stmt->execute()) {
        $_SESSION['success'] = "Department deleted successfully";
    } else {
        $_SESSION['error'] = "Error deleting department: " . $con->error;
    }
                        ...
                        <table class="table table-striped custom-table mb-0 datatable">
                            ...
                            <tbody>
                              ...
                              ?>
                                <tr>
                                    <td><?php echo $i++; ?></td>
                                    <td><img src="<?php echo $row['departmentimage']; ?>" height="50"></td>
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="departments.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this department?');"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                              <?php
                                  ...
                                  echo "<tr><td colspan='6' class='text-center'>No departments found</td></tr>";
                              }
                              ?>
                             </tbody>
                        </table>
