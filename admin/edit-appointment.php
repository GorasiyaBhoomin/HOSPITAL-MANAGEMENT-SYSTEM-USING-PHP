                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="appointmentname" value="Monil">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="email" value="Monil@gmail.com">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="phone" value="2525252525">
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <option value="" disabled selected>Select a Doctors</option>
                                                <option value="Dr.Yash" selected>Dr.Yash</option>
                                        </select>
        ...
        <div id="time-slots-container">
            <div class="time-slot-row d-flex">
                ...
                <div class="col-sm-6">
                    ...
                    <textarea class="form-control" rows="3" cols="30" name="message" value="">wehjegjhhgej</textarea>
