...
$appointments_sql = "SELECT a.*, d.username as doctor_name, dept.departmentname as department_name 
                    FROM appointments a 
                    LEFT JOIN doctors d ON a.username = d.username 
                    LEFT JOIN departments dept ON a.departmentname = dept.departmentname 
                    ORDER BY a.appointment_date DESC";
$appointments_result = $con->query($appointments_sql);
                        ...
                        <table class="table table-striped custom-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($appointment['appointmentname']); ?></td>
                                    ...
                                    <td><?php echo $appointment['consultancy_fees']; ?></td>
                                    ...
                                    <td>
                                        <span class="custom-badge status-<?php echo strtolower($appointment['status']); ?>">
