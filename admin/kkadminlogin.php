    ...
    if (!empty($email) && !empty($password)) {
        ...
        if ($result->num_rows === 1) {
            ...
            if (password_verify($password, $admin['password'])) {
                ...
                // Set success message
                $_SESSION["login_success"] = "Admin successfully logged in!";
...
<head>
    ...
    <title>KK PATEL HOSPITAL - Admin Login</title>
        ...
        <div class="account-page">
            <div class="account-center">
                <div class="account-box">
                    ...
                    <form action="kkadminlogin.php" id="login" method="POST" class="form-signin">
