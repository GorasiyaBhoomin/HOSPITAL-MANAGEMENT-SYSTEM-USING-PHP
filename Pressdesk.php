            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text">
                        <h3>Press Desk</h3>
                        <p><a href="index.php">Home /</a> Press Desk</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="our_department_area">
    <div class="container">
        ...
        <div class="row">
            <?php
            // Fetch press desk items from database
            $sql = "SELECT * FROM press_desk";
            ...
            if ($result->num_rows > 0) {
                    ...
                    <div class="col-xl-4 col-md-6 col-lg-4">
                        <div class="single_department">
                            <div class="department_thumb">
                                <img src="admin/<?php echo $row['pressimage']; ?>" alt="<?php echo $row['description']; ?>">
                            </div>
                ...
                echo "<p class='text-center'>No press desk items found</p>";
            }
            ?>
        </div>
    </div>
